...
//         productsInCart[i].price = productsInCart[i].count * productsInCart[i].basePrice;
...
//                   <button class="button-minus" onclick="plus(-1)" data-id="${
//                     product.id
//                   }">-</button>
//                   <span class="countOfProduct">${product.count}</span>
//                   <button class="button-plus" onclick="plus(1)" data-id="${product.id}">+</button>
//               </div>
...
//       <div class="item-td">
//         <button class="prd-cart_delete" data-id="${product.id}">
//           X
//         </button>
//       </div>
//     </div>
...
console.log($('.productPrice-item'));
var prd_imgs = $('.item-prd-link');
var prd_prices = $(".productPrice-item")
var prd_quantity = $(".productQuantity-item")
var totalPay = $(".total-end-price")
