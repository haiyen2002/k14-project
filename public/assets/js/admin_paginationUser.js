    ...
    try {
        ...
        if (res.status == 200) {
            ...
            newdata.map((ele, index) => {
                ...
                <td><a href="#${
                    ele._id
                }" class="btn_delete" onclick="deleteUser('${
                    ele._id
                }')">Delete</a></td>
                <td><a href="#${
                    ele._id
                }" class="btn_user"  onclick="viewsUser('${
                    ele._id
                }')">Views</a></td>
                <td><a href="#${
                    ele._id
                }" class="btn_role"  onclick="changeRole('${
                    ele._id
                }')">Role</a></td>
                <td><a href="/admin/userOrderDetail/${
                    ele._id
                }" class="btn_order">views</a></td>
              </tr>
                `;
